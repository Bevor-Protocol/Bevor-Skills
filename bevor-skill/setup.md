...
**`Scope keys`** — stems of **`*.raw.md`** in that folder (e.g. `AAAB` from `AAAB.raw.md`). Use this list to assign agents; do not re-derive scopes from API calls unless you truly need extra fields.
